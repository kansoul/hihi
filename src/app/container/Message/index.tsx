              ...
              <div className="bg-grey-lighter flex-1 overflow-auto">
                ...
                <div className="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-grey-lighter py-4">
                    ...
                    <p className="text-grey-dark mt-1 text-sm">Show me the money!</p>
                  </div>
                </div>
                <div className="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer">
                  <div>
                  ...
                  <div className="ml-4 flex-1 border-b border-grey-lighter py-4">
                    ...
                    <p className="text-grey-dark mt-1 text-sm">Tell Java I have the money</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="py-2 px-3">
                  ...
                  <div className="flex mb-2">
                    <div className="rounded py-2 px-3" style={{ backgroundColor: '#F2F2F2' }}>
                      ...
                      <p className="text-sm mt-1">Hi all! I have one question for the movie</p>
                      <p className="text-right text-xs text-grey-dark mt-1">12:45 pm</p>
                    </div>
                  </div>
                  <div className="flex mb-2">
