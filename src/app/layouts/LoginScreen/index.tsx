...
import { GET_USER, LOGIN_USER } from '../../services/schemas/user';
import { InputControl } from '../../components/Base/FormControl/InputControl';
import { toast } from 'react-toastify';
import { useNavigate } from 'react-router-dom';
import { useAppDispatch } from '../../hooks';
import { setAccessToken, setCurrentUser, setIsAuthenticated } from '../../features/auth/authSlice';
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(handleFormLogin)}>
              <div>
                <InputControl control={control} name="username" type="text" label="Your Username" />
              </div>
              <div>
                <InputControl control={control} name="password" type="password" label="Password" />
              </div>
